...
UnknownText_0x1c4ae5::	
	...
	text_ram wSeerNickname
	text "만큼 강한"
	cont "포켓몬을 보는 건 오랜만이네"

	para "분명 @"
	text_ram wSeerNickname
	text "의 배틀은"
	line "주변에서 보는 사람들을"
	cont "두근두근하게 할 것이 분명하구먼!"
	done
